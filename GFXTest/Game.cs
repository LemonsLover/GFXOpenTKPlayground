...
namespace BasicOpenTK
{
    public class Game : GameWindow
    {
        ...
        {
            this.KeyDown += OnMouseMoveEv;
            this.RenderFrequency = 144;
            this.CenterWindow();
        }
        ...
        protected override void OnLoad()
        {
            ...
            VertexPositionColor[] vertices = new VertexPositionColor[(boxCount * 4) + 3];
            this.vertexCount = 0;
            ...
            vertices[this.vertexCount++] = new VertexPositionColor(new Vector2(100, 0), new Color4(1f, 0f, 0f, 1f));
            vertices[this.vertexCount++] = new VertexPositionColor(new Vector2(50, 100), new Color4(0f, 1f, 0f, 1f));
            vertices[this.vertexCount++] = new VertexPositionColor(new Vector2(150, 100), new Color4(0f, 0f, 1f, 1f));


            int[] indices = new int[(boxCount * 6) + 3];
            this.indexCount = 0;
            this.vertexCount = 0;
        ...
        protected void OnMouseMoveEv(KeyboardKeyEventArgs e)
        {
            if(e.Key == Keys.W)
